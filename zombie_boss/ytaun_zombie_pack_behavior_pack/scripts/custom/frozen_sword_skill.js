...
// v2 REBALANCE: Ice Burst trước đây chỉ debuff, không có dame — thêm dame để
// đồng bộ với các vũ khí khác trong bộ (candy scythe, harvester scythe, ...).
const ICE_BURST_DAMAGE = 6;
        ...
        nearby.forEach((entity, index) => {
            system.runTimeout(() => {
                try {
                    ...
                    entity.applyDamage(ICE_BURST_DAMAGE, {
