...
LANG = {
    "en_US": {
        ...
        "toji.skill.plunge": "Heavenly Rampage",
        ...
        "toji.bar.plunge_ready": "§dJump: Rampage",
        "toji.bar.plunge_used": "§8Rampage used",
        ...
        "toji.title.awaken_hint": "§7Awakened — §fjump§7 for §dHeavenly Rampage",
        ...
        "toji.guide.3": "§f Sneak + right-click §7— §fChain of a Thousand Miles§7: whirl the spear around you, then hurl it (hit = yank, wall = grapple)",
        ...
        "toji.guide.6": "§f Hold 20s + jump §7— §dHeavenly Rampage§7: run all over a 20x20 area, 40 cuts on every mob, then back",
    ...
    "vi_VN": {
        ...
        "toji.skill.plunge": "Thiên Dữ Loạn Trảm",
        ...
        "toji.bar.plunge_ready": "§dNhảy: Loạn Trảm",
        "toji.bar.plunge_used": "§8Đã dùng Loạn Trảm",
        ...
        "toji.title.awaken_hint": "§7Đã thức tỉnh — §fnhảy§7 để dùng §dThiên Dữ Loạn Trảm",
        ...
        "toji.guide.3": "§f Khuỵu + chuột phải §7— §fXích Vạn Lý§7: quay mâu theo xích quanh người rồi ném (trúng địch = giật về, trúng tường = kéo mình tới)",
        ...
        "toji.guide.6": "§f Cầm 20s + nhảy §7— §dThiên Dữ Loạn Trảm§7: chạy khắp vùng 20x20 chém 40 nhát vào từng con mob rồi quay về",
