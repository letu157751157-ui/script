...
LANG = {
    "en_US": {
        ...
        "toji.guide.6": "§f Hold 20s + jump §7— §dHeaven-Splitting Plunge§7: leap onto the nearest enemy and drive the spear through it",
    ...
    "vi_VN": {
        ...
        "toji.guide.6": "§f Cầm 20s + nhảy §7— §dGiáng Thiên Nhất Kích§7: lao lên rồi cắm mâu xuống kẻ địch gần nhất",
