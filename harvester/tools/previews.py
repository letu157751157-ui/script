...
SKILL_POSES = [
    ...
    ("Phantom Scythes", "skill_throw", 0.3, -30),
    ("Chains of the Damned", "skill_chains", 0.75, 25),
    ("Death's Step", "skill_ambush", 0.4, 35),
    ("Hands of the Underworld", "skill_hands", 0.5, 25),
    ("Soul Rend", "skill_rend", 0.8, 30),
    ("Graves of the Plagued", "skill_summon", 0.95, 40),
    ("Shadow Reapers", "skill_reapers", 0.4, 25),
